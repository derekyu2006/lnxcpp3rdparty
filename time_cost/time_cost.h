/*
 * Copyright (c) 2017, Newstone Inc. All rights reserved.
 */
#ifndef CCOMMON_TIME_COST_TIME_COST_H
#define CCOMMON_TIME_COST_TIME_COST_H
...
#endif  // CCOMMON_TIME_COST_TIME_COST_H
