 // Copyright [2017] hoddis(newstonemarket.com)
...
TEST(TestTimeCost, DateStringToTimeStamp) {
  ...
  int64_t millisecs_01 = newstone::ccommon::DateStringToUTCTimeStamp(date_str_01);
  ...
  millisecs_01 = newstone::ccommon::DateStringToUTCTimeStamp(date_str_01);
  std::cout << "utc timestamp of date[" << date_str_01 << "] is ["
    << millisecs_01 << "]." << std::endl;
